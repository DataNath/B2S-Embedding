...
let viz;
const url =
  "https://public.tableau.com/views/EmbeddingDashboard_16867363212490/EmbeddingDashboard?:language=en-US&:display_count=n&:origin=viz_share_link";
...
const exportexcelbutton = document.getElementById("exportCrossTab");
exportexcelbutton.addEventListener("click", exportCTfunction);
function exportCTfunction() {
